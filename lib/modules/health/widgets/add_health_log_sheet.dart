...
void showAddHealthLogSheet(BuildContext context) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    builder: (_) => const _AddHealthLogSheet(),
  );
}

class _AddHealthLogSheet extends ConsumerStatefulWidget {
  const _AddHealthLogSheet();

  @override
  ConsumerState<_AddHealthLogSheet> createState() => _AddHealthLogSheetState();
}

class _AddHealthLogSheetState extends ConsumerState<_AddHealthLogSheet> {
  ...
  Future<void> _save() async {
    ...
    await ref.read(healthNotifierProvider.notifier).addLog(
          date: _date,
          weight: weight,
          waistCm: waist,
          bodyFatPct: bodyFat,
